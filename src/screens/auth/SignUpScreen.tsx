...
export default function SignUpScreen() {
  ...
  const [formState, setFormState] = useState<SignUpCredentials & { isLoading: boolean; error: string | null }>({
    email: '',
    password: '',
    confirmPassword: '',
    isLoading: false,
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Join thousands of users making informed vegan choices
          </Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          {formState.error && !formState.error.includes('email') && !formState.error.includes('Password') && !formState.error.includes('match') && (
