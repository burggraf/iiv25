...
export default function HistoryIcon({ size = 24, color = '#14A44A' }: HistoryIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 161.029 167.279">
      <G>
        <Path
          fill={color}
          d="M132.077,19.833C99.45-7.837,50.57-3.82,22.9,28.805c-27.671,32.627-23.653,81.507,8.972,109.177
        ...
        <Path
          fill={color}
          d="M92.423,40.309c0-2.117-1.717-3.833-3.834-3.833s-3.833,1.716-3.833,3.833v38.491l-27.887,26.512
