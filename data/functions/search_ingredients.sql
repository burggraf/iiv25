-- Search Ingredients PostgreSQL Function
-- Created: 2025-01-17
-- Purpose: Secure ingredient search with authentication check and automatic logging
-- 
-- This function provides a hierarchical search strategy for ingredients:
-- 1. Exact match search
-- 2. Starts-with pattern search  
-- 3. Contains pattern search
--
-- Features:
-- - SECURITY DEFINER: Bypasses RLS restrictions while maintaining user authentication
-- - Automatic logging: All searches logged to actionlog table with metadata
...
-- 4. Valid ingredient classes are pre-defined in the function
